  ...
  <body>
    ...
    <header class="layout-header">
        <h1>
            ...
            <a class="deconnexion" href="function.php">DECONNEXION</a>
        </h1>
    ...
    <div class="container">			
        ...
        <form id="form1" method="post" action="process-homepage.php" > 
            <fieldset>
                <legend>Purchase Calculator</legend>
                ...
                <input id="price" type="number" step="0.01" name="unit_price" placeholder="0-9"
                ...
                <input id="quantity" type="number" name="article_quantity" placeholder="0-9"
