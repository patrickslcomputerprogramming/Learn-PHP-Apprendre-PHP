...
<html>  
  ...
  <body>			
    <h1>Analyse d'un Jeu de Données</h1>
    <hr>
    <!--Form--> 
    <form id="form1" method="post" action="<?php echo $_SERVER['SCRIPT_NAME']; ?>" > 
      <!--Form fields to input data-->
      <label for="input1">Entrez une jeu de données incluant 1 virgule entre chaque 2 nombres</label> 
...
?>
  ...
  <body>			
    <h1>Résultat de l'Analyse du Jeu de Données</h1>
    <hr>
<?php
    ...
    //Create messages
    $messages=array(
            'err'=>'SVP, entrez une jeu de données incluant 1 virgule entre chaque 2 nombres.',
            'dataset'=>"Vous avez entré les nombres suivants: ",
            'size'=>"Le nombre de nombres entrés: ",
            'asc'=>"Les nombres entrés en ordre croissant: ",
            'des'=>"Les nombres entrés en ordre décroissant: ",
            );
...
?>
    <p><a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>">Recommencez!</a></p>
  </body>
</html>
