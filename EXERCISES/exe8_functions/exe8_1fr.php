...
<html>  
  ...
  <body>	
    <div class="container">
        <h1 class="bluetext">Somme, Difference, et Produit</h1>
        <hr>
        <!--Form--> 
...
?>
 ...
 <?php
    ...
    echo"<p>Vous avez entré : $userInput</p>";
    echo'<div id="sum">';
        getSum($userInput);
    echo'</div>';
    echo'<div id="diff">';
...
?>
    <div id="back">
        <a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>"><input type="submit" value="Essayez à Nouveau!"></a>
    </div>
    </div> 
  </body>
</html>
