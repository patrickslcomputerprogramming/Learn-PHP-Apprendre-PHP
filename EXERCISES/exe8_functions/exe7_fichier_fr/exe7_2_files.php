...
$location = "C:/wamp64/www/dw3/file-test-class.txt";
...
function createNewFile($fileNameLocation, $message){
...
function addDataToFile($fileNameLocation, $data, $message){
...
createNewFile($location, msg());
addDataToFile($location, $content, msg());
